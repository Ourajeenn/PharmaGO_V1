...
import { Loader2, Eye, EyeOff, Bike, Clock, MapPin, CreditCard, ArrowLeft, Truck, CheckCircle2, ShieldCheck, Zap, Upload, X } from 'lucide-react'
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      ...
                      className="relative w-16 h-16 rounded-full bg-slate-100 border-2 border-dashed border-slate-300 flex items-center justify-center cursor-pointer hover:border-amber-500 hover:bg-amber-50 transition-all overflow-hidden group"
                    >
                      {profileImage ? (
                        <img
